...
class CompanyTable:
    ...
    @allure.step("SQL. Добавить компанию. Название: {name}; Описание: {description}")
    ...
    @allure.step("SQL. Получить ID последней добавленной компании")
    ...
    @allure.step("SQL. Удалить компанию по ее ID ({id})")
...
class EmployeeTable:
    ...
    @allure.step("SQL. Получить список сотрудников компании по ее ID ({id})")
    ...
    @allure.step("SQL. Удалить сотрудника по его ID ({id})")    
